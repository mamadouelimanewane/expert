        ...
        <div className="space-y-12 pb-20 animate-in fade-in duration-1000">
            ...
            <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-indigo-950/20 p-4 sm:p-8 lg:p-12 rounded-[60px] border border-white/5 relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10">
                    ...
                    <h1 className="text-2xl sm:text-3xl lg:text-5xl font-black text-white tracking-tight underline decoration-indigo-500/50 decoration-8 underline-offset-12 mb-8 uppercase">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {SUCCESS_STORIES.map((story) => (
                    <div key={story.id} className="glass-card p-4 sm:p-6 lg:p-10 rounded-[20px] sm:rounded-[36px] lg:rounded-[50px] border border-white/5 bg-slate-900/40 relative group overflow-hidden transition-all hover:border-indigo-500/30">
                        <div className="flex justify-between items-start mb-8 relative z-10">
                            ...
                            <div className={cn("px-6 py-4 rounded-[32px] flex flex-col items-center justify-center", story.bg)}>
                                <span className={cn("text-xl sm:text-2xl lg:text-3xl font-black", story.color)}>{story.metric}</span>
            ...
            {/* CTA */}
            <div className="p-4 sm:p-8 lg:p-16 rounded-[60px] bg-gradient-to-r from-indigo-600 to-indigo-800 text-white flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-8 lg:gap-12 shadow-2xl shadow-indigo-600/20">
                <div className="max-w-xl text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black uppercase tracking-tight mb-4 leading-none">Votre succès est notre priorité</h2>
